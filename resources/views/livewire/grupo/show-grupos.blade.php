<div>
    ...
    <div class="w-full flex flex-col px-5 md:py-6">
        <div class="w-full">
            <x-jet-section-title>
                <x-slot name="title">Administracion Grupos</x-slot>
                <x-slot name="description">Permite visualizar y dar mantenimiento a los grupos configurados en el sistema</x-slot>
            </x-jet-section-title>
        </div>
    </div>
