    ...
    <div class="w-full flex flex-col space-y-3 py-5 px-5">
        ...
        @foreach ($topicos as $topico)
            ...
            <div class="w-full flex flex-row bg-white rounded-lg shadow-lg p-3 border border-blue-200">
                ...
                <div class="flex-1 text-gray-700 text-3xl flex justify-center flex flex-col text-center">
                    @if($topico->estatus=="1")
                ...
                <div class="flex-1">
                    @livewire('topico.autorizar-puesto',['id_topico'=>$topico->id,key('2_'.$topico->id)])
                </div>
            </div>
        @endforeach
        @if($registros==0)
